...
export default function MazokuBloodstoneINR() {
  ...
  const handleCopy = async () => {
    if (!inrAmount) return;
    const text = `\`\`\`css
Bloodstone Amount:   ${bloodstoneAmount} ${bloodstoneAmount === 1 ? "BS" : "BS"}
...
-# Calculated Using: [PayPal | Sofi | Karuta | Mazoku Fee Calculator by ItsMe Prince](https://paypal-and-sofi-wist-fee-calculator.vercel.app/)`;
  ...
  const breakdownRows = inrAmount
    ? [
        {
          label: "Bloodstone Amount",
          value: `${bloodstoneAmount} ${bloodstoneAmount === 1 ? "BS" : "BS"}`,
  ...
  return (
    <PageWrapper>
      <div className="min-h-screen flex items-center justify-center p-4">
        <TopRightMenu currency={"usd"} href={"/mazoku-bloodstone"} />
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-2 font-mono text-[11px] tracking-[0.12em] uppercase text-white/30">
                ...
                Mazoku · Bloodstone Calculator (INR)
              </div>
