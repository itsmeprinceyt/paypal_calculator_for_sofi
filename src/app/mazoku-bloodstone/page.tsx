...
export default function SofiWist() {
    ...
    const handleBloodstoneAmountChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
        <div className="h-screen flex flex-col justify-center items-center text-yellow-950">
            ...
            <div className={`relative w-[350px] sm:w-[600px] h-96 transition-transform duration-500 ${isFlipped ? "rotate-y-180" : ""}`} style={{ perspective: "1000px", transformStyle: "preserve-3d", }}>
                ...
                >
                    <h1 className="text-xl font-semibold text-yellow-950 z-10">Enter Bloodstone Amount ...</h1>
                    <div className="relative flex justify-center items-center shadow-md shadow-yellow-600/60 rounded-md">
                        ...
                        <input
                            ...
                            className={`z-10 antialiased text-center text-4xl p-2 rounded-r-md text-black w-[250px] focus:outline-none placeholder:text-2xl ${isInputDisabled ? "bg-yellow-950 cursor-not-allowed" : ""}`}
                            disabled={isInputDisabled}
                        />
                    </div>
                    <h1 className="text-xl font-semibold text-yellow-950 z-10">Enter Ratio ...</h1>
                    <div className="relative flex justify-center items-center shadow-md shadow-yellow-600/60 rounded-md">
                        <input
                            id="ratio"
                            type="number"
                            ...
                            className={`z-10 antialiased text-center text-4xl p-2 rounded-l-md text-yellow-950 w-[150px] focus:outline-none ${isInputDisabled ? "bg-yellow-950 cursor-not-allowed" : ""}`}
                            disabled={isInputDisabled}
                        />
