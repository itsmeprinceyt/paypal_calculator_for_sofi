...
-# Calculated Using: [PayPal | Sofi | Karuta | Mazoku Fee Calculator by ItsMe Prince]( https://paypal-and-sofi-wist-fee-calculator.vercel.app/)`;
    ...
    return (
        <div className="h-screen flex flex-col justify-center items-center text-white">
            ...
            <div className={`relative w-[350px] sm:w-[600px] h-80 transition-transform duration-500 ${isFlipped ? "rotate-y-180" : ""}`} style={{ perspective: "1000px", transformStyle: "preserve-3d", }}>
                {/* Front Side */}
                <div
                        ...
                        <div className="flex flex-col gap-3 w-10/12 text-white">
                            <div className="text-center text-xl">
                                <p className="font-light">
                                    ...
                                    <span className="font-bold text-lg scale-110"> ${result.fee}</span> as fee and you will receive approximately 
