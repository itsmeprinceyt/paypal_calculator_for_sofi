  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center text-white">
      ...
      >
        {/* Front Side */}
        <div
          className={`absolute w-full h-full bg-gradient-to-r from-orange-900 to-orange-500 rounded-2xl shadow-orange-600/50 shadow-2xl p-5 backface-hidden flex flex-col justify-center items-center gap-5 ${
            isFlipped ? "hidden" : ""
          }`}
          style={{
        ...
        >
          ...
          <div className="flex gap-5 mt-5">
            ...
            <Link href={"/karuta-ticket-inr"}>
              <button className="z-10 bg-white rounded-md px-5 h-[45px] text-orange-950 shadow-orange-600/80 hover:shadow-orange-600 shadow-xl hover:scale-105 transition-all ease-in-out duration-200 flex justify-center items-center">
                Switch to INR
              </button>
            </Link>
          </div>
